...
<meta property="og:image" content="{{ $page->media($page->image ? $page->image : $page->site->image) }}">
...
<meta name="twitter:image" content="{{ $page->media($page->image ? $page->image : $page->site->image) }}">
